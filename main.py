...
print("Task 1: Máx f(x1,x2) = 15x1 + 30x2 + 4x1x2 - 2x1^2 - 4x2^2")
print("x1 + 2x^2 <= 30")
print("x1 >= 0, x2 >= 0")
print("x1:", population1[0][0], "x2:", population1[0][1], "f(x1,x2):", population1[0][2])
population2 = geneticAlgorithms(fitness, f2, crossover, crossover1, mutation, selection, ver2, sort,  population, 100)
print("Task 2: Máx f(x1,x2) =3x1 + 5x2")
print("x1 <= 30")
print("2x2 <= 12")
print("3x1 + 2x2 <= 18")
print("x1 >= 0, x2 >= 0")
print("x1:", population2[0][0], "x2:", population2[0][1], "f(x1,x2):", population2[0][2])
population3 = geneticAlgorithms(fitness, f3, crossover, crossover1, mutation, selection, ver3, sort,  population, 100)
print("Task 3: Máx f(x1,x2) = 5x1 - x1^2 + 8x2 - 2x2^2")
print("3x1 + 2x^2 <= 6")
print("x1 >= 0, x2 >= 0")
print("x1:", population3[0][0], "x2:", population3[0][1], "f(x1,x2):", population3[0][2])